...
?>
<?php
if($cupri_general['disable_default_style']!=1){
?>
<style type="text/css">
...
foreach ($_cupri['type'] as $wc_cf_key => $wc_cf) {
    ...
    if($_cupri['type'][$wc_cf_key] == 'text' && isset($_cupri['text_default'][$wc_cf_key]))
    {
	...
	if(isset($_cupri['disable'][$wc_cf_key]) && $_cupri['disable'][$wc_cf_key] == 1){continue;}
	...
	$placeholder = esc_attr( $_cupri['name'][$wc_cf_key] );
	...
	echo '<input placeholder="'.$placeholder.'" value="'.$value.'" required="required" type="number" name="cupri_f' . $wc_cf_key . '" id="cupri_f' . $wc_cf_key . '">';
	
	break;
	case 'mobile':
	echo '<input placeholder="'.$placeholder.'" ' . $required . ' type="text" name="cupri_f' . $wc_cf_key . '" id="cupri_f' . $wc_cf_key . '">';
	
	break;
	case 'email':
	echo '<input placeholder="'.$placeholder.'" ' . $required . ' type="email" name="cupri_f' . $wc_cf_key . '" id="cupri_f' . $wc_cf_key . '">';
	...
	case 'text':
	echo '<input placeholder="'.$placeholder.'" value="'.$value.'" ' . $required . ' type="text" name="cupri_f' . $wc_cf_key . '" id="cupri_f' . $wc_cf_key . '">';
	break;
	case 'checkbox':
...
echo '<button class="cupri_full_centered" name="cupri_submit" id="cupri_submit">'.$submit_button_text.'<img width="7px" style="display:none;" class="cupri_ajax_img" src="'.cupri_url.'/assets/ajax-loader.gif"></button>';
