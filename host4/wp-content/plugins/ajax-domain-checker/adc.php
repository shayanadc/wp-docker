...
$content = '<div id="domain-form">
	<form method="post" action="./" id="form" class="pure-form"> 
		<input type="text" autocomplete="off" id="بررسی قابلیت ثبت" name="domain" placeholder="نام دامنه مورد نظر را وارد نمایید" class="" style="width:100%;max-width:'.$atts['width'].'px;"> 
