...
<div id="wpcrlResetPasswordSection" class="container-fluid <?php echo empty($is_url_has_token) ? ' hidden' : 'ds' ?>">
    <div class="row">
        <div class="col-xs-8 col-md-10"> 
            ...
            $resetpassword_form_heading = empty($wpcrl_form_settings['wpcrl_resetpassword_heading']) ? 'بازیابی رمز عبور' : $wpcrl_form_settings['wpcrl_resetpassword_heading'];
            $resetpassword_button_text = empty($wpcrl_form_settings['wpcrl_resetpassword_button_text']) ? 'بازیابی رمز عبور' : $wpcrl_form_settings['wpcrl_resetpassword_button_text'];
            $returntologin_button_text = empty($wpcrl_form_settings['wpcrl_returntologin_button_text']) ? 'ورود به حساب کاربری' : $wpcrl_form_settings['wpcrl_returntologin_button_text'];           
            ...
            <form name="wpcrlResetPasswordForm" id="wpcrlResetPasswordForm" method="post">
                ...
                if (!$is_url_has_token) :
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="wpcrl_rp_email" id="wpcrl_rp_email" placeholder="ایمیل">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="wpcrl_newpassword" id="wpcrl_newpassword" placeholder="رمز عبور جدید">
                    </div>
